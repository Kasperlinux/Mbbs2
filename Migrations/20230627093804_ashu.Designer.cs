...
{
    [DbContext(typeof(DhsMagacousesContext))]
    [Migration("20230627093804_ashu")]
    partial class ashu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mbbs2.Models.AgeEligibilityCriterion", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.ApplicantsAlliedCourse", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.ApplicantsAnm", b =>
                {
                    b.Property<int?>("AgeAsOnCutOffDate")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.ApplicantsGnm", b =>
                {
                    b.Property<int?>("AgeAsOnCutOffDate")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.ApplicantsMbb", b =>
                {
                    b.Property<int>("ApplicantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mbbs2.Models.Domain.DHS", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Mbbs2.Models.MApplicationStatus", b =>
                {
                    b.Property<int>("ApplicationStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.MApplicationType", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MBlock", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MCategory", b =>
                {
                    b.Property<int?>("Category")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.MCoursesAlliedCourse", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MCoursesAnm", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MCoursesGnm", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MCoursesMbb", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MDistrict", b =>
                {
                    b.Property<int>("DistrictCode")
                        .HasColumnType("int")
                        .HasColumnName("District_Code");
            ...
            modelBuilder.Entity("Mbbs2.Models.MGender", b =>
                {
                    b.Property<string>("Gender")
                        .HasMaxLength(1)
                        .HasColumnType("nchar(1)")
            ...
            modelBuilder.Entity("Mbbs2.Models.MNationality", b =>
                {
                    b.Property<int?>("Nationality")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.MReligion", b =>
                {
                    b.Property<int>("Religion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.MScreeningCentre", b =>
                {
                    b.Property<int?>("ApplicationType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mbbs2.Models.MState", b =>
                {
                    b.Property<int>("StateCode")
                        .HasColumnType("int")
                        .HasColumnName("State_Code");
            ...
            modelBuilder.Entity("Mbbs2.Models.MUser", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.MVillage", b =>
                {
            ...
            modelBuilder.Entity("Mbbs2.Models.PreferenceAlliedCourse", b =>
                {
                    b.Property<int?>("AcCourseCode")
                        .HasColumnType("int")
                        .HasColumnName("AC_CourseCode");
            ...
            modelBuilder.Entity("Mbbs2.Models.PreferenceMbb", b =>
                {
                    b.Property<int?>("ApplicantId")
                        .HasColumnType("int")
                        .HasColumnName("Applicant_Id");
            ...
            modelBuilder.Entity("Mbbs2.Models.Session", b =>
                {
